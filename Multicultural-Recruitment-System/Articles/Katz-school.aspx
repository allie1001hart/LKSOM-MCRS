<%@ Page Title="" Language="C#" MasterPageFile="~/MCRS_Student.Master" AutoEventWireup="true" CodeBehind="Katz-school.aspx.cs" Inherits="Multicultural_Recruitment_System.Articles.Katz_school" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Katz School of Medicine Donors Set the Pace for Temple University’s $97 Million Fundraising Year</title>
  ...
  <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div>
                        <h2>
                            Katz School of Medicine Donors Set the Pace for Temple University’s $97 Million Fundraising Year
                        </h2>
                        <br><br>
                </div>
                    ...
                    <p>
                        The generosity of Temple Heath donors set the pace for Temple University’s $97 million fundraising year, representing 38% of <a href="https://news.temple.edu/news/2018-09-20/temple-closes-another-record-breaking-year-fundraising?utm_source=social&utm_medium=Twitter&utm_content=FundraisingRecord&utm_campaign=SocialMedia2018">Temple’s $97 million raised</a> in FY18.
