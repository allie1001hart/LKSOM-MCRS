<%@ Page Title="" Language="C#" MasterPageFile="~/MCRS_Student.Master" AutoEventWireup="true" CodeBehind="Temple Lung.aspx.cs" Inherits="Multicultural_Recruitment_System.Articles.Temple_Lung" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Temple Lung Center Director Reports Continued Positive Results for Study Examining Minimally Invasive Treatment of Severe Emphysema</title>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div>
                    <h2>Temple Lung Center Director Reports Continued Positive Results for Study Examining Minimally Invasive Treatment of Severe Emphysema
                    </h2>
                    <br>
                    <br>
                </div>
