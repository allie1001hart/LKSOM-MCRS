<%@ Page Title="" Language="C#" MasterPageFile="~/MCRS_Student.Master" AutoEventWireup="true" CodeBehind="dr-cecelia.aspx.cs" Inherits="Multicultural_Recruitment_System.dr_cecelia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Dr. Cecelia Schmalbach Appointed The Inaugural David Myers, MD Professor and Chair in Otolaryngology-Head and Neck Surgery at the Lewis Katz School of Medicine at Temple University</title>
        ...
        <div class="row">
            ...
            <div class="op">
                    ...
                    <p>
                        ...
                        <div class="footer">
                                <div class="footer-copyright text-center py-3">&copy Temple University
                                </div>
                        </div>
            </div>
            <div class="col-lg-4"></div>
